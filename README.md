...
- Local CSV: set `DATA_SOURCE_PATH` (defaults to `src/data/sample_options.csv`).
...
### Sample Data
A small CSV at `src/data/sample_options.csv` is included for offline exploration. Point `DATA_SOURCE_PATH` at your own file or cloud object for production data.
